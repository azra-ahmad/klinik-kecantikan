  ...
  <div class="mx-auto px-8 py-5 flex justify-between items-center">
    ...
    <div class="flex items-center space-x-4 md:space-x-5">
      <ul class="hidden md:flex space-x-4 md:space-x-6">
        ...
        <li>
          <a href="promo.php" class="rounded-md px-3 py-2 text-lg font-medium hover:bg-blue-500 hover:bg-opacity-80">
            Promo
          </a>
        </li>
        <li>
          <a href="treatment.php" class="rounded-md px-3 py-2 text-lg font-medium hover:bg-blue-500 hover:bg-opacity-80">
            Treatment
          </a>
        </li>
        <li>
          <a href="product.php" class="rounded-md px-3 py-2 text-lg font-medium hover:bg-blue-500 hover:bg-opacity-80">
            Product
          </a>
        </li>
        <li>
